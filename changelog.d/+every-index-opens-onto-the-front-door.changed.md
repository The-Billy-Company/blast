...
they were being shown a page about the Python binding's verbs - not the composed face, or why it needs both engines at once.

The README could not simply be pointed at, because a relative link resolves
against whatever page displays it. `src/surface/face/blast/README.md` is correct on GitHub and a 404
under `pypi.org/project/blast-search/`. crates.io is the worse of the two: it rewrites
